...
public class ProductApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Product created successfully. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Product deleted successfully. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 400 </td><td> The request is malformed. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 401 </td><td> Authorization information is missing or invalid. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 402 </td><td> Authenticated user doesn&#39;t have subscription. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Authenticated user doesn&#39;t have access to the resource. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
     ...
     */
    public okhttp3.Call listProductCall(Integer page, Integer perPage, String query, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listProductValidateBeforeCall(Integer page, Integer perPage, String query, final ApiCallback _callback) throws ApiException {
        return listProductCall(page, perPage, query, _callback);
     ...
     */
    public ProductList listProduct(Integer page, Integer perPage, String query) throws ApiException {
        ApiResponse<ProductList> localVarResp = listProductWithHttpInfo(page, perPage, query);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProductList> listProductWithHttpInfo(Integer page, Integer perPage, String query) throws ApiException {
        okhttp3.Call localVarCall = listProductValidateBeforeCall(page, perPage, query, null);
     ...
     */
    public okhttp3.Call listProductAsync(Integer page, Integer perPage, String query, final ApiCallback<ProductList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listProductValidateBeforeCall(page, perPage, query, _callback);
        Type localVarReturnType = new TypeToken<ProductList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Product updated successfully. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 400 </td><td> The request is malformed. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 401 </td><td> Authorization information is missing or invalid. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
        <tr><td> 402 </td><td> Authenticated user doesn&#39;t have subscription. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Authenticated user doesn&#39;t have access to the resource. </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  * X-RateLimit-Reset - The timestamp at which the current rate limit window resets. <br>  * Retry-After - How many seconds you have to wait before making new request. <br>  </td></tr>
