...
public class UtilApi {
    ...
    /**
     * Build call for checkTaxNumber
     * @param taxNumber  (required)
     ...
     */
    public okhttp3.Call checkTaxNumberCall(String taxNumber, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/utils/check-tax-number/{tax_number}"
    ...
    private okhttp3.Call checkTaxNumberValidateBeforeCall(String taxNumber, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'taxNumber' is set
        if (taxNumber == null) {
            throw new ApiException("Missing the required parameter 'taxNumber' when calling checkTaxNumber(Async)");
        }

        return checkTaxNumberCall(taxNumber, _callback);
     ...
     */
    public TaxNumber checkTaxNumber(String taxNumber) throws ApiException {
        ApiResponse<TaxNumber> localVarResp = checkTaxNumberWithHttpInfo(taxNumber);
     ...
     */
    public ApiResponse<TaxNumber> checkTaxNumberWithHttpInfo(String taxNumber) throws ApiException {
        okhttp3.Call localVarCall = checkTaxNumberValidateBeforeCall(taxNumber, null);
        Type localVarReturnType = new TypeToken<TaxNumber>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Check tax number. (asynchronously)
     * Check the given tax number format, and NAV validate.
     * @param taxNumber  (required)
     ...
     */
    public okhttp3.Call checkTaxNumberAsync(String taxNumber, final ApiCallback<TaxNumber> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkTaxNumberValidateBeforeCall(taxNumber, _callback);
        Type localVarReturnType = new TypeToken<TaxNumber>(){}.getType();
     ...
     */
    public okhttp3.Call getServerTimeCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/utils/time";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getServerTimeValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getServerTimeCall(_callback);
     ...
     */
    public ServerTime getServerTime() throws ApiException {
        ApiResponse<ServerTime> localVarResp = getServerTimeWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ServerTime> getServerTimeWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getServerTimeValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<ServerTime>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get the server time (asynchronously)
     * Return the server time.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getServerTimeAsync(final ApiCallback<ServerTime> _callback) throws ApiException {

        okhttp3.Call localVarCall = getServerTimeValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<ServerTime>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
